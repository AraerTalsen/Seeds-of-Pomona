...
public class TargetCoordinator
{
    ...
    public TargetCoordinator(Affector.TargetLabel targetMode, EffectContext context)
    {
        if(targetMode == Affector.TargetLabel.self) context.target = context.owner.transform;
    }
